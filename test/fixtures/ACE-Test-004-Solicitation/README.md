# ACE-Test-004-Solicitation

A minimal fixture exercising the **Solicitation Management (Phase 7)**
...
- Two `Preferred LLOs` so `llo-invite` (the new Phase 7 step 2) has
  recipients to email.
...
- Phase 7→8 handoff (no `selected_llo` populated; that's the
