# ACE-Test-001 — Synthetic Test Fixture
...
```
/ace:step <skill-name> ACE-Test-001 --dry-run
```

### Option 2: Push to GDrive first
Copy these files to `ACE/ACE-Test-001/` in the shared Google Drive, then run skills against them as you would a real opportunity.

### Option 3: Full lifecycle test
```
/ace:run ACE-Test-001 --mode review --dry-run
```
