...
Same as `ACE-Test-001`. Always use `--dry-run`:

```
/ace:run ACE-Test-002 --mode review --dry-run
```

Or single-step:

```
/ace:step <skill-name> ACE-Test-002 --dry-run
```
