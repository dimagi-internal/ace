...
export const ARTIFACT_MANIFEST: readonly ArtifactEntry[] = [
  ...
  {
    path: '1-design/pdd-to-test-prompts-qa_result.yaml',
  ...
  {
    path: '1-design/pdd-to-test-prompts-eval_verdict.yaml',
  ...
  {
    path: '3-connect/connect-opp-setup-eval_verdict.yaml',
  ...
  {
    path: '5-qa-and-training/training-deck-outline-eval_verdict.yaml',
    producedBy: 'training-deck-outline-eval',
    role: 'verdict',
    consumedBy: ['opp-eval'],
    phase: 'qa-and-training',
    required: false,
    description: 'Companion-eval verdict from `training-deck-outline-eval`. Grades pedagogical flow, screenshot integration, anticipated-question coverage.',
  },
  {
    path: '5-qa-and-training/training-faq-eval_verdict.yaml',
  ...
  {
    path: '5-qa-and-training/training-flw-guide-eval_verdict.yaml',
  ...
  {
    path: '5-qa-and-training/training-llo-guide-eval_verdict.yaml',
  ...
  {
    path: '5-qa-and-training/training-onboarding-email-eval_verdict.yaml',
  ...
  {
    path: '5-qa-and-training/training-quick-reference-eval_verdict.yaml',
  ...
  {
    path: '6-synthetic/synthetic-narrative-plan-qa_result.yaml',
  ...
  {
    path: '6-synthetic/synthetic-walkthrough-spec_<persona>-qa_result.yaml',
  ...
  {
    path: '6-synthetic/synthetic-summary-eval_verdict.yaml',
  ...
  {
    path: '7-solicitation-management/solicitation-review-qa_result.yaml',
  ...
  {
    path: '8-execution-manager/llo-uat-eval_verdict.yaml',
  ...
  {
    path: '9-closeout/learnings-summary-eval_verdict.yaml',
