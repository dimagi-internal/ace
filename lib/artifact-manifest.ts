...
export const ARTIFACT_MANIFEST: readonly ArtifactEntry[] = [
  ...
  },
  {
    ...
    phase: 'qa-and-training',
    required: false,
    description: 'Machine-readable verdict from app-ux-eval (deep). Read by llo-launch (Phase 8 activation gate) for freshness check vs. latest released CommCare build, and by opp-eval for cross-skill aggregation. Required to be fresh and passing for go-live; absent if /ace:qa-deep has not been run.',
  },
  {
