...
6. **Auto-surfaced concerns.** Severity rules per
   ...
   - `[BLOCKER]` for each mechanism on
     `_app-component-library.md § Known-unbuildable mechanisms` that the PDD
