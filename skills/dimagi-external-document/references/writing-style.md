...
How Dimagi external documents *read* — the voice, tone, and language conventions that complement the visual identity. Apply these while drafting content in markdown, before any styling work begins.
