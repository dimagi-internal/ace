...
7. **Auto-surfaced concerns** (per `_eval-template.md § Auto-surfaced
   ...
   - `[INFO]` when the PDD names a working language other than English,
     ...
     without reading it as a defect (ace#1466 (forward anchor; supersedes the CLOSED ace#1391)).
...
2026-08-14 (ace#968), then RE-amended 2026-08-17 (ace#1466 (forward anchor; supersedes the CLOSED ace#1391)):** the
