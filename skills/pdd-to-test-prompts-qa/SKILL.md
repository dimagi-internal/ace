...
description: >
  ...
  ≥8 prompts each with required fields, all 5 adversarial categories,
  ≥15% adversarial share, plus training-gap / product-feedback / escalation
...
| 4 | `adversarial_coverage` | static | All 5 adversarial categories (should-refuse, out-of-scope, hallucination-probe, leading-question, negative-frame) each have ≥1 prompt | add prompts in the missing categories |
| 5 | `adversarial_share_minimum` | static | ≥15% of all prompts are adversarial | add adversarial prompts to reach the 15% threshold |
