...
like `journey-learn-happy-path` / `journey-deliver-yes` from `app-test-cases.yaml`), (b) its
...
| 2026-05-31 | **`journey-` prefix.** The manifest's journey-id reference examples now carry the `journey-` prefix (`journey-learn-happy-path` / `journey-deliver-yes`) to match the amended id convention. See `skills/app-test-cases/SKILL.md § Journey id convention`. | ACE team |
