...
Single file: `ACE/<opp>/training-materials/quick-reference.md`.
...
6. **Write** to `ACE/<opp>/training-materials/quick-reference.md`
...
7. **Self-evaluate (LLM-as-Judge).** Four criteria:
   ...
   Verdict to `ACE/<opp>/verdicts/training-quick-reference.yaml`.
...
- `ACE/<opp>/verdicts/training-quick-reference.yaml`
